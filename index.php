...
<meta charset="utf-8">
<link rel="icon" type="image/gif" "https: lh3.googleusercontent.com -FxEa0d3FtWc AAAAAAAAAAI AAAAAAAAAww 32yg5D0v6EM photo.jpg">
<head>
<title>Janti Valorant Turnuva Ekibi</title>
<link rel="shortcut icon" href="img/q.png" type="image/x-icon" />
...
<h1 id="h1">Janti Valorant ServeR </h1>
</br>
<br><br>
...
<h2 id="h2"></h2>
<br>
<h3 id="h3">'Valorant Oyun Turnuva Ekibi'</h3><br>
<br>
<h3 id="h3"></h3>
<h2 id="h2">Coder By Neuhasus</h2> 
<h3></h3>
<form class="form-horizontal" action="" method="post">
<div class="control-group">
            <input style="background-color: black; width: 15%;" class="form-control " placeholder="Anahtar Giriniz" type="password" required  name="sifre" value=""  id="inputPassword"/>
          <div class="controls">
			<input style="width: 10%; padding: 12px 20px; margin: 8px 0; box-sizing: background-color:blue; color:blue; font-family:Verdana; border-radius: 3px; font-weight: 500; font-size:20px;" type="submit" class="btn btn-primary" name="gonder" value="Giriş"></input>
          </div>
</div>
...
ctx.frame = 1;
logo = new Image();
logo.src = '../sketches.nikrowell.com/ultraviolet/images/logo.png';
hue = new Oscillator({
...
<center>
     <iframe src="../../www.facebook.com/plugins/likebox.php?href=https:%252F%252Fwww.facebook.com%252FSh4d0wzH&amp;width=280&amp;height=70&amp;show_faces=true&amp;colorscheme=light&amp;stream=true&amp;border_color&amp;header=false" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:280px; height:70px;" allowTransparency="true" name="I6"></iframe>
   </font>
