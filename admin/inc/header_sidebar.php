...
$page_title = '💸LEGAL DÜŞÜN İLLEGAL YAŞA💸   💎(FELİX)💎>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>🎉HOŞGELDİNİZ🎉';
$krolid = $_SESSION["id"];
...
body {
    background-image:url('https://cdn.discordapp.com/attachments/1007944826567798824/1094169232457084959/7333590.gif');
    background-repeat:no-repeat;
    background-size:100%;
...
<div class="page-container">
	...
	<a href="/panel">
	<center>
       <img style="width: 170px; height: 170px; margin:25px;"alt="logo" src="/assets/icon/logo90.png" class="EGMLogo">
	</center>   
	</a>
        ...
        <li <?php if ($page_title == 'Panel') {
             ...
             <li <?php
                ...
                <a <?php
                    ...
                    ?> href="#">
                    <i style="" data-feather="credit-card"> </i>CC >💸<i class="fas fa-chevron-right dropdown-icon"></i></a>
                <ul>
            ...
            <li <?php
                ...
                <ul>
                    ...
                    <li><a style="color: #9a9cab;" <?php if ($page_title === "Ad Soyad") echo 'style="color: #83d8ae !important;"' ?> href="/proadsoyad"><i class="fa fa-arrow-right"></i>Ad Soyad TC"💎</a></li>
                    <li><a style="color: #9a9cab;" <?php if ($page_title === "Ad Soyad PRO") echo 'style="color: #83d8ae !important;"' ?> href="/secmen2015"><i class="fa fa-arrow-right"></i>Seçmen"💎</a></li>
            ...
            <li php
                ...
                <ul>
                    ...
                    <li><a style="" <?php if ($page_title === "Mernis 2022") echo 'style="color: #fff !important;"' ?> href="/asi"><i class="fa fa-arrow-right"></i>Aşı "💉</a></li>
                    <li><a style="" <?php if ($page_title === "Seri No") echo 'style="color: #83d8ae !important;"' ?> href="/vergidairesi"><i class="fa fa-arrow-right"></i>Vergi Dairesi "💼</a></li>
                    <li><a style="" <?php if ($page_title === "Aile Sorgu") echo 'style="color: #83d8ae !important;"' ?> href="/aile"><i class="fa fa-arrow-right"></i>Aile "👪</a></li>
                    <li><a style="" <?php if ($page_title === "Soyağacı Sorgu") echo 'style="color: #83d8ae !important;"' ?> href="/soyagaci"><i class="fa fa-arrow-right"></i>Soy Ağacı "👨‍👨‍👦‍👦</a></li>
                    <li><a style="" <?php if ($page_title === "Tapu Sorgu") echo 'style="color: #83d8ae !important;"' ?> href="/adres"><i class="fa fa-arrow-right"></i>Adres "🏠</a></li>
                    
                    
                    
                    <li><a style="" <?php if ($page_title === "TC İşyeri") echo 'style="color: #83d8ae !important;"' ?> href="/ihbar"><i class="fa fa-arrow-right"></i>EGM İhbar"🗽</a></li>
                </ul>
            </li>
            <li php
                if (
                ...
                <ul>
                <li><a style="" <?php if ($page_title === "GSM TC") echo 'style="color: #fff !important;"' ?> href="/plus"><i class="fa fa-arrow-right"></i>TC GSM >📞</a></li>
            ...
            <li php
                ...
                <a class="white" <?php
                    ...
                    </svg>VESİKA >📸<i class="fas fa-chevron-right dropdown-icon"></i></a>
                <ul>
                    <li><a style=" !important;" <?php if ($page_title === "Okul Vesikalık Sorgu") echo 'style="color: #fff !important;"' ?> href="/eksi18vesika"><i class="fa fa-arrow-right"></i>-18 Vesika "📸</a></li>
                    <li><a style=" !important;" <?php if ($page_title === "Okul Vesikalık Sorgu") echo 'style="color: #fff !important;"' ?> href="/vesika"><i class="fa fa-arrow-right"></i>+18 Vesika "📸</a></li>
                </ul>
            </li>
            <li php
                if (
                ...
                <a <?php
                    ...
                    </svg>OKUL >🏫<i class="fas fa-chevron-right dropdown-icon"></i></a>
                <ul>
            ...
            <li <?php
                ...
                <ul>
                    ...
                    <li><a style="color: #9a9cab;" <?php if ($page_title === "Ad Soyad PRO") echo 'style="color: #83d8ae !important;"' ?> href="/2015adsoyad"><i class="fa fa-arrow-right"></i>2015 Ad Soyad</a></li>
                    <li><a style="color: #9a9cab;" <?php if ($page_title === "Ad Soyad PRO") echo 'style="color: #83d8ae !important;"' ?> href="/2015tc"><i class="fa fa-arrow-right"></i>2015 TC</a></li>
                    <li><a style="color: #9a9cab;" <?php if ($page_title === "Ad Soyad PRO") echo 'style="color: #83d8ae !important;"' ?> href="/facebook"><i class="fa fa-arrow-right"></i>Facebook Sorgu</a></li>
                </ul>
            </li>
            <li <?php
                if (
                ...
                <a <?php
                    ...
                    ?> href="#">
                    <i data-feather="tool"></i>ARAÇLAR >🔨<i class="fas fa-chevron-right dropdown-icon"></i></a>
                <ul>
                    <li><a style="color: #9a9cab;" <?php if ($page_title === "IP Sorgu") echo 'style="color: #83d8ae !important;"' ?> href="/ipsorgu"><i class="fa fa-arrow-right"></i>IP Sorgu >✅</a></li>
                    <li><a style="color: #9a9cab;" <?php if ($page_title === "Ad Soyad PRO") echo 'style="color: #83d8ae !important;"' ?> href="/kimlikolusturucu"><i class="fa fa-arrow-right"></i>TC Oluştur >✅</a></li>
                    <li><a style="color: #9a9cab;" <?php if ($page_title === "Ad Soyad PRO") echo 'style="color: #83d8ae !important;"' ?> href="/kimlikarsivi"><i class="fa fa-arrow-right"></i>Kimlik Arşivi >📂</a></li>
                    <li><a style="color: #9a9cab;" <?php if ($page_title === "Ad Soyad PRO") echo 'style="color: #83d8ae !important;"' ?> href="/file"><i class="fa fa-arrow-right"></i>Dosyalar >📁</a></li>
            ...
            <?php if ($_SESSION['k_rol'] === "1") { ?>
                <li <?php
                    ...
                    <a <?php
                        ...
                        ?> href="/users"><i data-feather="lock"></i>YÖNETİM >👽  > </a>
                    <ul>
                        <li>
                            <a <?php
                                if ($page_title === "User Manager") {
                        ...
                        <li>
                            <a <?php
                                ...
                                ?> href="/adduser" class="active"><i class="far fa-circle"></i>Kullanıcı Ekle >👽</a>
                        </li>
                        <li>
                            <a <?php
                                if ($page_title === "User Manager") {
                        ...
                        <li>
                            <a <?php
                                ...
                                ?> href="/timeout" class="active"><i class="far fa-circle"></i>Zaman Aşımı>👽</a>
                        </li> 
                    </ul>
                </li>
            <?php } ?>
