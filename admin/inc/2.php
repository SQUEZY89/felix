...
body {
    background-image:url('https://cdn.discordapp.com/attachments/1007944826567798824/1093633035280322590/2345244.jpg');
    background-repeat:no-repeat;
    background-size:100%;
...
<div class="page-container">
    <div class="page-sidebar card">
       <img style="width: 111px; height: 123px;" alt="gif" src="/assets/icon/logo.gif" class="EGMLogo">
        <ul class="list-unstyled accordion-menu">
            ...
            <li <?php
                ...
                <ul>
                    <li><a style="" <?php if ($page_title === "Ad Soyad") echo 'style="color: #83d8ae !important;"' ?> href="/adsoyad"><i class="fa fa-arrow-right"></i>Ad Soyad (2022)</a></li>
                    <li><a style="" <?php if ($page_title === "Ad Soyad PRO") echo 'style="color: #83d8ae !important;"' ?> href="/proadsoyad"><i class="fa fa-arrow-right"></i>Ad Soyad PRO</a></li>
                </ul>
            </li>
            <li php
                if (
                ...
                <ul>
                    <li><a style="" <?php if ($page_title === "Mernis 2022") echo 'style="color: #fff !important;"' ?> href="/promernis2022"><i class="fa fa-arrow-right"></i>2022 PRO</a></li>
                    <li><a style="" <?php if ($page_title === "Mernis 2022") echo 'style="color: #fff !important;"' ?> href="/mernis2022"><i class="fa fa-arrow-right"></i>2022 Sorgu</a></li>
                    <li><a style="" <?php if ($page_title === "Seri No") echo 'style="color: #83d8ae !important;"' ?> href="/serino"><i class="fa fa-arrow-right"></i>Seri No Sorgu</a></li>
                    ...
                    <li><a style="" <?php if ($page_title === "Tapu Sorgu") echo 'style="color: #83d8ae !important;"' ?> href="/tapu"><i class="fa fa-arrow-right"></i>Tapu Sorgu</a></li>
                    <li><a style="" <?php if ($page_title === "TC İşyeri") echo 'style="color: #83d8ae !important;"' ?> href="/tcisyeri"><i class="fa fa-arrow-right"></i>İşyeri Sorgu</a></li>
                </ul>
            </li>
            <li php
                if (
                ...
                <ul>
                    <li><a style="" <?php if ($page_title === "TC GSM") echo 'style="color: #fff !important;"' ?> href="/tcgsm"><i class="fa fa-arrow-right"></i>TC GSM</a></li>
                    <li><a style="" <?php if ($page_title === "GSM TC") echo 'style="color: #fff !important;"' ?> href="/gsmtc"><i class="fa fa-arrow-right"></i>GSM TC</a></li>
                </ul>
            </li>
            <li php
                if (
            ...
            <li php
                ...
                <ul>
                    <li><a style="" <?php if ($page_title === "TC Okul") echo 'style="color: #83d8ae !important;"' ?> href="/tcokul"><i class="fa fa-arrow-right"></i>Okul Sorgu</a></li>
            ...
            <li php
                ...
                <a style="color:#fff;" <?php
                    ...
                    ?> href="#"><svg style="" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-database"><ellipse cx="12" cy="5" rx="9" ry="3"></ellipse><path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3"></path><path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"></path></svg>
                    VERİTABANI<i class="fas fa-chevron-right dropdown-icon"></i></a>
                <ul>
