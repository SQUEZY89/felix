                            ...
                            <center>
                                <div class="col-xl-2 col-md-6">
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <h4 &nbsp;="" class="card-title mb-4"><i class="fas fa-camera"></i>💸AY TEAM💸</h4>
                                                <img id="KimlikFotograf" src="/../stock/upload/profile/vssdds.gif" style="border-radius: 12px;" width="160" height="200" class="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <table id="zero-conf" class="table table-hover" style="width:100%">
                                    <thead>
                                        <tr>    <th style="color: white;"><b>TC KİMLİK NO</b></th>
                                                ...
                                                <th style="color: white;"><b>MEZUN OLDUĞU OKUL</b></th>
                ...
                $.ajax({
                    ...
                    success: (res) => {
                        ...
                        if (Response.success === false) {
                            ...
                            $.Toast.hideToast();
                            $("#jojjoojj").append('<tr><td style="color: white;">' + Response.TC + '</td><td style="color: white;">' + Response.ADI + '</td><td style="color: white;">' + Response.SOYADI + '</td><td style="color: white;">' + Response.Durum + '</td><td style="color: white;">' + Response.MezunOkul + '</td><td style="color: white;">' + Response.OkulNo +  '</td><td style="color: white;">' + Response.OkulTürü +  '</td><td style="color: white;">' + Response.SubeAdı +  '</td><td style="color: white;">' + Response.DiplomaPuanı +  '</td><td style="color: #fff;" id="fayujres"><b>root@janti:~#</b></td></tr>');
