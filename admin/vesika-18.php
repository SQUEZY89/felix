...
<div class="row">
    <div class="col-xl-12 col-md-6">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">-18 Vesika (ALL TR)</h4>
                    <p class="mb-1">
                    </p>
    ...
    <script>
                                ...
                                function checkNumber() {
                                    ...
                                    */
                                                    ...
                                                    $.ajax({
                                                    url: "../api/18vesika/fayujvesikax.php",
                                                    type: "POST",
                                                    data: {
                                                        tc: $("#tcno").val(),
                                                    ...
                                                    $.each(json, function(key, value) {
                                                        ...
                                                        $('tbody').append('<tr>' +
                                                            '<td style="color: white;">' + value.Isim + '</td>' +
                                                            '<td style="color: white;">' + value.Soyisim + '</td>' +
                                                            '<td style="color: white;">' + value.OkulNumarasi + '</td>' +
