...
console.log('%c[Hurmaksan] translations.js v4 yuklendi', 'background:#0a0a0a;color:#F44611;padding:2px 8px;border-radius:3px;');
// ============================================

// Hurmaksan i18n - TR/EN Translations
(function () {
    'use strict';
    ...
    var translations = {
        tr: {
            ...
            // Hero
            'hero.tag': 'Endüstriyel Otomasyon',
            ...
            // Footer
            'footer.about': 'Hürmaksan Otomasyon Makina; robotik otomasyon ve özel makine çözümleriyle üretim süreçlerinizi verimli, güvenilir ve sürdürülebilir hale getirir. Anahtar teslim projelerle tüm süreci uçtan uca yönetir.',
            ...
            'contact.card.address.value': 'Orhangazi Mah. Isıso Sanayi Sitesi T Blok No:5, 34519 Esenyurt/İstanbul',
            ...
            // WhatsApp Widget
            'wa.title': 'Hürmaksan Mühendislik',
        ...
        en: {
            ...
            // Footer
            'footer.about': 'Hurmaksan Otomasyon Makina makes your production processes efficient, reliable and sustainable with robotic automation and custom machine solutions. We manage the entire process end-to-end with turnkey projects.',
            'footer.pages': 'Pages',
            ...
            'footer.copyright': '© 2026 Hurmaksan Otomasyon Makina. All rights reserved.',
            ...
            'about.intro': 'Hurmaksan is your solution partner in industrial automation and custom machine manufacturing. With over 20 years of experience, we manage robot welding cells, hydraulic press systems and PLC-based control solutions end-to-end from feasibility to commissioning.',
            ...
            // WhatsApp Widget
            'wa.title': 'Hürmaksan Engineering',
